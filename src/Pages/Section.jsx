...
const Section = () => {
  ...
  const UpdatClassGetApi = async () => {
    ...
    try {
      ...
      console.log('class-get-all-api-data-in-section-page for class id', response);
      if (response?.status === 200) {
  ...
  const MySectionGetApi = async () => {
    setLoader(true)
    try {
      const response = await SectionRoomGetApi(searchKey);
  ...
  return (
    <Container>
      ...
      <div className="container-fluid main-body p-3">
          ...
          <div className="breadCrum ms-2">
            <nav style={{ '--bs-breadcrumb-divider': "'>'" }} aria-label="breadcrumb">
              <ol className="breadcrumb ms-2">
                ...
                <li className="breadcrumb-item breadcrum-li heading-14" ><Link href="#">Section</Link></li>
              </ol>
            </nav>
          </div>
        ...
        <h5 className='ms-3 mb-2 margin-minus22 heading-16' style={{ marginTop: '-22px' }}>Section List</h5>
        ...
        <div className="offcanvas offcanvas-end" tabindex="-1" id="staticBackdrop00" aria-labelledby="offcanvasRightLabel">
          {/* ########## content area #################  */}
          {
            show && (
              <>
                ...
                <div class="offcanvas-body pt-0">
                  <div className="inputs">
                    <div className="">
                      ...
                      <div className="mb-1  ">
                        <label for="exampleFormControlInput1" className="form-label label-color heading-16 ">Room</label>
                        <select class="form-select form-focus w-100 label-color heading-14 " value={roomChange} onChange={(e) => setRoomChange(e.target.value)} aria-label="Default select example">
                  ...
                  <div className='my-button11 '>
                    <button type="button" className="btn btn-outline-success heading-16 btn-bgAndColor" onClick={(e) => MySectionPutApi(idForPut)}>Update Section</button>
