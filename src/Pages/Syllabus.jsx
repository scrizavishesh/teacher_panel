...
const Syllabus = () => {
  ...
  const MySyllabusGetApi = async () => {
    setLoader(true)
    try {
      const response = await SyllabusGetAllApi(searchKey,classId, sectionId);
          ...
          <div className="breadCrum ms-2">
            <nav style={{ '--bs-breadcrumb-divider': "'>'" }} aria-label="breadcrumb">
              <ol className="breadcrumb ms-2">
                ...
                <li className="breadcrumb-item breadcrum-li heading-14" ><Link href="#">Syllabus</Link></li>
              </ol>
            </nav>
          </div>
        ...
        <div className="main-content-conatainer pt-1 ">
          ...
          <div className="row mb-3 buttons-topss">
            <div className='my-button11 heading-16'>
              <button type="button" class="btn btn-outline-success" onClick={MySyllabusGetApi}>Search</button>
              ...
              <>
                ...
                <div className="offcanvas-body pt-0">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="file" class="form-control form-control-sm" id="exampleFormControlInput1" onChange={(e) => handleImageFile(e.target.files[0])} placeholder="Select Class" />
                  </div>
                  <div>
