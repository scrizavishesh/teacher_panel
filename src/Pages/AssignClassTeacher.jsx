...
const MyAssignClassTeachgerGetApi = async () => {
  setLoader(true)
    try {
      const response = await AssignClassTeacherGetAllApi();
      console.log('AssignAll classtecaher-get-all-api', response);
      if (response?.status === 200) {
        toast.success(response?.data?.msg)
        ...
        <Container>
          {
            ...
            <div className="container-fluid main-body p-3">
                    ...
                    <div className="breadCrum ms-2">
                        <nav style={{ '--bs-breadcrumb-divider': "'>'" }} aria-label="breadcrumb">
                            <ol className="breadcrumb ms-2">
                                ...
                                <li className="breadcrumb-item breadcrum-li heading-14" ><Link href="#">Assign Class Teacher</Link></li>
                            </ol>
                        </nav>
                    </div>
                ...
                <h5 className='ms-3 mb-2 margin-minus22 heading-16' style={{ marginTop: '-22px' }}>Assign Class Teacher Details</h5>
