...
const Holiday = () => {
  ...
  // const [holidayNameGetById, setHolidayNameGetById] = useState()
  // const [holidayDateGetById, setHolidayDateGetById] = useState()
  // const [holidayDescriptionGetById, setHolidayDescriptionGetById] = useState()
  ...
  const FuncValidation = () => {
    ...
    // description
    if (holidayDescription === "" || !holidayDescription) {
  ...
  const MyHolidayGetAllApi = async () => {
    setLoader(true)
    try {
      const response = await HolidayGetAllApi(searchKey);
  ...
  const MyHolidayPutApi = async (id) => {
    ...
    try {
      const formData = new FormData()
      formData.append('holidayTitle', holidayNameGetById)
      formData.append('holidayDescription', holidayDescriptionGetById)
      formData.append('holidayDate', holidayDateGetById)
