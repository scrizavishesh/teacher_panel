...
import { OfflinePostApi } from '../Utils/Apis'
import { OfflineDeleteApi } from '../Utils/Apis'
import { OfflineGetByIdApi } from '../Utils/Apis'
import { OfflinePutApi } from '../Utils/Apis'
...
const OfflineExam = () => {
    ...
    console.log('id for upudateeee', IdForUpdate)
    ...
    // console.log('exam name ',examCategory )
    ...
    const ClassRoomGetAllApi = async () => {
        setLoader(true)
        try {
            const response = await ClassRoomGetApi();
    ...
    const MyOfflineExamDeleApi = async (id) => {
        setLoader(true)
        try {
            const response = await OfflineDeleteApi(id);
    ...
    const MyAssignLeaveGetByIdApi = async (id) => {
        ...
        setLoader(true)
        try {
            const response = await OfflineGetByIdApi(id);
                            ...
                            <>
                                ...
                                <div class="offcanvas-body pt-0">
                                    <div className="input " >
                                        ...
                                        <div className="mb-3 mt-3" style={{ marginTop: '-6px' }}>
                                            <label for="exampleFormControlInput1" className="form-label label-color heading-14">Date </label>
                                            <input type="date" className="form-control form-focus   heading-14" value={date} onChange={(e) => setDate(e.target.value)} style={{ marginTop: '-4px' }} id="exampleFormControlInput1" placeholder="100.00" />
                                        </div>
                                        <div className="mb-3 mt-3" style={{ marginTop: '-6px' }}>
                                            <label for="exampleFormControlInput1" className="form-label label-color heading-14">Starting Time</label>
                                            <input type="time" className="form-control form-focus   heading-14" value={startTime} onChange={(e) => setStartTime(e.target.value)} style={{ marginTop: '-4px' }} id="exampleFormControlInput1" placeholder="100.00" />
                                        </div>
                                        <div className="mb-3 mt-3" style={{ marginTop: '-6px' }}>
                                            <label for="exampleFormControlInput1" className="form-label label-color heading-14">Ending Time </label>
                                            <input type="time" className="form-control form-focus   heading-14" value={endTime} onChange={(e) => setEndTime(e.target.value)} style={{ marginTop: '-4px' }} id="exampleFormControlInput1" placeholder="100.00" />
                                        </div>


                                        <div className="mb-3 mt-3" style={{ marginTop: '-6px' }}>
                                            <label for="exampleFormControlInput1" className="form-label label-color heading-14">Total Marks </label>
                                            <input type="email" className="form-control form-focus heading-14" value={marks} onChange={(e) => setMarks(e.target.value)} style={{ marginTop: '-4px' }} id="exampleFormControlInput1" placeholder="Marks" />
                                        </div>
