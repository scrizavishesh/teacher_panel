...
import SmsSettingState1 from './SmsSettingState1';
import SmsSettingState2 from './SmsSettingState2';
import SmsSettingState3 from './SmsSettingState3';
    ...
    <div className="container-fluid main-body p-3">
     ...
     <nav style={{ '--bs-breadcrumb-divider': "'>'" }}aria-label="breadcrumb">
         <ol className="breadcrumb ms-2">
             ...
             <li className="breadcrumb-item active heading-14 font-color" aria-current="page">SMS Center</li>
             <li className="breadcrumb-item breadcrum-li heading-14" ><Link href="#">SMS Settings</Link></li>
         </ol>
     </nav>
     </div>
     ...
     <div className="main-content-conatainer pt-1 ">
        ...
        {/* ####### buttons ######  */}
         ...
         <ul class="nav nav-underline  ps-3 gap-5 myActive-Line heading-14 ">
            <li class="nav-item  pb-0 ">
                <Link class="nav-link " onClick={()=> setTabclick('tab1')} to="#" >Active a SMS Getway</Link>
            </li>

            <li class="nav-item  pb-0">
                <Link class="nav-link my-navlink-tabs" onClick={()=> setTabclick('tab2')} to="#">Twilio</Link>
            </li>
            <li class="nav-item  pb-0">
                <Link class="nav-link" onClick={()=> setTabclick('tab3')} to="#">MSG91</Link>
            </li>
        </ul>
        <hr className='my-0'/>

          {tabclick==='tab1'&& <SmsSettingState1 />}
          {tabclick==='tab2'&& <SmsSettingState2 />}
          {tabclick==='tab3'&& <SmsSettingState3 />}
          </div>
