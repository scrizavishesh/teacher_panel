        ...
        <Container>
         ...
         <nav style={{ '--bs-breadcrumb-divider': "'>'" }}aria-label="breadcrumb">
             <ol className="breadcrumb ms-2">
                 ...
                 <li className="breadcrumb-item breadcrum-li heading-14" ><Link href="#">Teacher Permission</Link></li>
             </ol>
         </nav>
         </div>
         ...
         <h5 className='ms-3 mb-2 margin-minus22 heading-16' style={{marginTop:'-22px'}}>Teacher Permission</h5>
               ...
               <img src="./images/image 1 (1).png" alt="" />
                ...
                <span className='ps-2 pt-1'>John doe</span>
                 ...
                 <td className=' greyText'>
                    ...
                    <input class="form-check-input my-input-check" type="checkbox" role="switch" id="flexSwitchCheckChecked"  />
                    </div>
                 </td>
                 <td className=' greyText'>
                    <div class="form-check form-switch">
...
export default TeacherPermission22
