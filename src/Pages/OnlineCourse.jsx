...
const OnlineCourse = () => {
  ...
  const handleLesson = (e2) => {
    setLesson(e2);
    const nameRegex = /^[A-Za-z]+$/;
    setIsValidLessonRequired(nameRegex.test(e2));
  ...
  const MyTeacherGetAllApi = async () => {
    setLoader(true)
    try {
      const response = await TeacherGetAllApi(2);
  ...
  const MyOnlinCoruseGetAllApi = async () => {
    setLoader(true)
    try {
      const response = await OnlineCourseGetAllApi();
  ...
  return (
    <Container>
      ...
      <div className="container-fluid main-body p-3">
        ...
        <h5 className='ms-3 mb-2 margin-minus22 heading-16' style={{ marginTop: '-22px' }}>Courses Details</h5>
              ...
              <div className="row mt-3">
                ...
                <div className="col-lg-2  col-md-6">
                  <div className='fixed-button tableGreyBackgroundColor greyInputTextColor ps-2 pt-0 pe-2 pt-2 d-flex justify-content-between'>
                    ...
                    <div className='under-circle'>
                      <p className='heading-14 greyInputTextColor'>5</p>
                    </div>
                  </div>
                </div>
        ...
        <div className="offcanvas offcanvas-end" tabindex="-1" id="staticBackdrop12" aria-labelledby="offcanvasRightLabel">
          {/* ########## content area #################  */}
          {
            show && (
              <>
                ...
                <div class="offcanvas-body pt-0">
                  <div className="input " >
                    ...
                    <div className="mb-3 for-media-margin">
                      <label for="exampleFormControlInput1" className="form-label label-color heading-16">Section </label>
                      <input type="email" className="form-control form-focus-input form-control-md heading-14 grey-input-text-color input-border-color" value={courseSection} onChange={(e) => handleSection(e.target.value)} style={{ borderRadius: '5px', marginTop: '-5px' }} id="exampleFormControlInput12" placeholder="Enter Section" />
                    </div>
                    <div className='pt-1'>
                      {isValidSectionRequired && (
                        <p className='ms-1' style={{ color: 'red', fontSize: '14px',  marginTop: '-18px' }}>
