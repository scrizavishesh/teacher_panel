...
const Expense_category = () => {
  ...
  const MyExpenseGetAllApi = async () => {
    setLoader(true)
    try {
      const response = await ExpenseCategorygetAllApi(expense);
  ...
  return (
    <Container>
      ...
      <div className="container-fluid main-body p-3">
        ...
        <h5 className='ms-3 mb-2 margin-minus22 heading-16' style={{ marginTop: '-22px' }}>Expenses Category Details</h5>
