...
// Pagination end 
  ...
  const MyTeacherGetAllApi = async () => {
    setLoader(true)
    try {
      const response = await TeacherGetAllApi(1, searchKey);
      ...
      <div className="container-fluid main-body p-3">
        ...
        <div className='d-flex justify-content-between for-dislay-direction'>
          ...
          <div className='d-flex g-1 for-media-query'>
            ...
            <Link type="button" className="btn btn-success heading-16 my-own-button me-3" to={'/addadminform'}>+ ADD Admin</Link>
          </div>

        </div>
        <h5 className='ms-3 mb-2 margin-minus22 heading-16' style={{ marginTop: '-22px' }}>Admin List</h5>
