...
import { IncomeCategoryPostApi } from '../Utils/Apis'
import { IncomeCategorygetAllApi } from '../Utils/Apis'
import { IncomeCategoryDeleteApi } from '../Utils/Apis'
import { IncomeCategoryGetByIdApi } from '../Utils/Apis'
import { IncomeCategoryPutApi } from '../Utils/Apis'
...
const Income_category = () => {
  ...
  console.log('my data ', incomeCategoryData)
  ...
  const MyIncomeCategoryPostApi = async () => {
    ...
    setLoader(true)
    try {
      const response = await IncomeCategoryPostApi(formData);
  ...
  const MyIncomeGetAllApi = async () => {
    ...
    try {
      ...
      console.log('my income category  data', response);
      if (response?.status === 200) {
        toast.success(response?.data?.msg)
  ...
  // Delete api
  const MyIncomeCategoryDelApi = async (id) => {
    setLoader(true)

    try {
      const response = await IncomeCategoryDeleteApi(id);
  ...
  //  Get by id 
  const MyIncomCateGetById = async (id) => {
    setIdForUpdate(id)
    setLoader(true)
    try {
      const response = await IncomeCategoryGetByIdApi(id);
      console.log('Income Get By Id', response)
 ...
 const MyIncomeCategoryPutApi = async () => {
  ...
  try {
    ...
    const response = await IncomeCategoryPutApi(IdForUpdate,formData);
      ...
      <div className="container-fluid main-body p-3">
        ...
        <div className='d-flex justify-content-between for-dislay-direction'>
          <div className="breadCrum ms-2">
            <nav style={{ '--bs-breadcrumb-divider': "'>'" }} aria-label="breadcrumb">
              <ol className="breadcrumb ms-2">
                ...
                <li className="breadcrumb-item breadcrum-li heading-14" ><Link href="#">Income Category</Link></li>
              </ol>
            </nav>
          </div>
          <div className='d-flex g-1 for-media-query'>
            ...
            <Link type="button" className="btn btn-success heading-16 my-own-button me-3 " data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" to={''}>+ Add Income Category</Link>
          </div>
        </div>
        <h5 className='ms-3 mb-2 margin-minus22 heading-16' style={{ marginTop: '-22px' }}>Income Category Details</h5>
            ...
            <table className="table table-sm table-striped">
              <thead className=''>
                <tr className='heading-16 text-color-000' style={{ fontWeight: '500' }}>
                  ...
                  <th style={{ width: '70%' }}>Income Category</th>
                      ...
                      <td className=' greyText' >
                        <div className="dropdown my-button-show">
                          ...
                          <ul className="dropdown-menu anchor-color heading-14">
                            <li><Link className="dropdown-item" to={''} data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight1234" aria-controls="offcanvasRight1234" onClick={(e) => MyIncomCateGetById(item.id)} >Edit</Link></li>
            ...
            show && (
              <>
                ...
                <div className="offcanvas-body pt-0">
                  <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label heading-16">Income Category Name</label>
                    <input type="text" class="form-control form-control-sm" id="exampleFormControlInput1"  onChange={(e) => setName(e.target.value)} placeholder="Income Category Name" />
                  </div>
                  <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label heading-16">Type Name</label>
                    <input type="text" class="form-control form-control-sm" id="exampleFormControlInput1"  onChange={(e) => setType(e.target.value)} placeholder="Type Name" />
                  </div>
                  <div className='my-button11 '>
                    <button type="button" className="btn btn-outline-success heading-16 my-green" onClick={MyIncomeCategoryPostApi}>Add Income Category</button>
        ...
        <div className="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight1234" aria-labelledby="offcanvasRightLabel">
          {
            showadd && (
              <>
                <div className="offcanvas-header">
                  <Link data-bs-dismiss="offcanvas" ><img src="./images/Vector (13).svg" alt="" /></Link>
                  <h5 className="offcanvas-title heading-16" id="offcanvasRightLabel">Edit Income Category</h5>
                </div>
                <hr className='' style={{ marginTop: '-3px' }} />
                <div className="offcanvas-body pt-0">
                  <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label heading-16">Income Category Name</label>
                    <input type="text" class="form-control form-control-sm" id="exampleFormControlInput1" value={name} onChange={(e) => setName(e.target.value)} placeholder="Income Category Name" />
                  </div>
                  <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label heading-16">Type Name</label>
                    <input type="text" class="form-control form-control-sm" id="exampleFormControlInput1" value={type} onChange={(e) => setType(e.target.value)} placeholder="Type Name" disabled/>
                  </div>
                  <div className='my-button11'>
                    <button type="button" className="btn btn-outline-success heading-16 btn-bgAndColor" onClick={MyIncomeCategoryPutApi}>Update Syllabus</button>
                    <button type="button" className="btn btn-outline-success heading-16">Cancel</button>
                  </div>
                </div>
                ...
                <div className="offcanvas-body">
                  ...
                  <div className="sure-main-container mt-4">
                    <div className="sure-container">
                      ...
                      <div className="mt-4">
                        <button type="button" className="btn my-btn  button00 my-button112233RedDelete" disabled={forDelete ? false : true} onClick={(e) => MyIncomeCategoryDelApi(IdForDelete)}>Delete</button>
