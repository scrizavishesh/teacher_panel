...
const Accountant = () => {
  ...
  const MyTeacherGetAllApi = async () => {
    ...
    setLoader(true)
    try {
      const response = await TeacherGetAllApi(4, searchKey);
      ...
      <div className="container-fluid main-body p-3">
        ...
        <div className='d-flex justify-content-between for-dislay-direction'>
          ...
          <div className='d-flex g-1 for-media-query'>
            ...
            <Link type="button" className="btn btn-success heading-16 my-own-button me-3" to={'/addadminform'}>+ ADD Accountant</Link>

          </div>

        </div>
        <h5 className='ms-3 mb-2 margin-minus22 heading-16' style={{ marginTop: '-22px' }}>Accountant List</h5>
            ...
            show && (
              <>
                <div className="offcanvas-header">
                  ...
                  <h5 className="offcanvas-title heading-16" id="offcanvasRightLabel">Edit Teacher</h5>
                </div>
                  ...
                  <div className="sure-main-container mt-4">
                    <div className="sure-container">
                      ...
                      <div class="form-check mt-1">
                        <input class="form-check-input my-form-check-input" onClick={()=>setForDelete(true)}   type="checkbox" value="" id="flexCheckDefault" />
