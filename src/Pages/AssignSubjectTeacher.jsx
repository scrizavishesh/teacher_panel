...
const AssignSubjectTeacher = () => {
  ...
  const MyAssignGetAllApi = async () => {
    setLoader(true)
    try {
      const response = await AssignGetAllApi(classId, subjectId);
      console.log('Assign get all data', response);
      if (response?.status === 200) {
        toast.success(response?.data?.msg)
          ...
          <div className="breadCrum ms-2">
            <nav style={{ '--bs-breadcrumb-divider': "'>'" }} aria-label="breadcrumb">
              <ol className="breadcrumb ms-2">
                ...
                <li className="breadcrumb-item breadcrum-li heading-14" ><Link href="#">Assign Subject Teacher</Link></li>
              </ol>
            </nav>
          </div>
        ...
        <div className="main-content-conatainer pt-1 ">
          ...
          <div className="row mb-3 buttons-topss">
            <div className='my-button11 heading-16'>
              <button type="button" class="btn btn-outline-success" onClick={MyAssignGetAllApi}>Search</button>
