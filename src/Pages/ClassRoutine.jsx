...
const ClassRoutine = () => {
  ...
  console.log('my subject id outside', subjectId)
  ...
  // classRoutineData.forEach((item) => {
  //     item?.classes?.forEach((item) => (
  //         item?.sections?.forEach((item)=>(
  //          item?.routinesByDay?.monday?.forEach((item)=>(
  //           rows.push(
  //             <tr key={item.id}>
  //               <td>{item.day}</td>
  //             </tr>
      ...
      <div className="container-fluid main-body p-3">
        ...
        <div className='d-flex justify-content-between for-dislay-direction'>
          ...
          <div className='d-flex g-1 for-media-query'>
            ...
            <Link type="button" className="btn btn-success heading-16 my-own-button me-3 " data-bs-toggle="offcanvas" data-bs-target="#staticBackdrop1012" aria-controls="offcanvasRight" to={''}>+ ADD Class Routine</Link>
          </div>
        </div>
