...
const Event = () => {
  ...
  const MyEventGetAllApi = async () => {
    setLoader(true)
    try {
      const response = await EventGetAllApi(searchKey);
  ...
  return (
    <Container>
      ...
      <div className="container-fluid main-body p-3">
        ...
        <h5 className='ms-3 mb-2 margin-minus22 heading-16' style={{ marginTop: '-22px' }}>Event Details</h5>
        ...
        <div className="offcanvas-end offcanvas" data-bs-backdrop="static" tabindex="-1" id="staticBackdrop1212" aria-labelledby="staticBackdropLabel">
          {/* <div className={` offcanvas-end offcanvas${offcanvasclose ? ' offcanvas-close' : ''}`} data-bs-backdrop="static" tabindex="-1" id="staticBackdrop" aria-labelledby="staticBackdropLabel"> */}
          {
            show && (
              <>
